...
<?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo (htmlspecialchars($field["value"])); ?>"
    ...
    <?php case "icon": ?><div class='icon-chose' title="选择icon" style="width: 400px;">
        ...
        <script src="/dev/opensns/Application/Admin/Static/zui/lib/chosen/chosen.icons.min.js"></script>
        <link href="/dev/opensns/Application/Admin/Static/zui/lib/chosen/chosen.icons.css" rel="stylesheet">
        <?php } ?>
        <script>
            $(function(){
...
<script type="text/javascript">
    ...
    <?php if($importDatetimePicker): ?><link href="/dev/opensns/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/dev/opensns/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.min.js"></script>
    ...
    <?php if($colorPicker): ?><script type="text/javascript" src="/dev/opensns/Application/Admin/Static/js/jquery.simple-color.js"></script>
        <script>
            $(function(){
    ...
    <link href="/dev/opensns/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet">
