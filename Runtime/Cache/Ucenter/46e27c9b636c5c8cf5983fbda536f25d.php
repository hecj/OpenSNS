                    ...
                    <div class="row">
                        <div class="col-xs-12 uc_fans" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li <?php if(($tab) == "following"): ?>class="active"<?php endif; ?>><a href=''
                                    >
                                    <?php if($uid == is_login()): else: endif; ?></a></li>
                                
                            </ul>
                        <!-- <form method="post" action="<?php echo U('photo',array('uid'=>$uid));?>" enctype="multipart/form-data">
