...
class IndexController extends BaseController
{
    ...
    public function photo($uid = null){
       /* $file = $_FILES['file'];
        ...
        if($file){
            ...
            if($info){
                foreach($info as $key=>$val){
                    $goods_data[$key]=Qiniu_Sing1($val['url']);
                }
            }
        }*/
        ...
        $str = "<a href='abcd' ><img src='/dev/opensns/Uploads/Editor/Picture/2015-09-21/55ffaf51b810f.jpg'></a>";
        preg_match($pattern,$str,$match);
        $this->assign('file',$match[1]);
